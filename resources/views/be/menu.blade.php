    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link @if (str_contains($title, 'Product')) active @endif" href="{{route('products.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
        <a class="nav-link @if ($title === 'User') active @endif" href="{{route('users.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60px" height="60px" viewBox="0 0 18 18"><path d="M9 8a3 3 0 1 0-3-3 3 3 0 0 0 3 3zm0 1.5c-2.5 0-7.5 1.25-7.5 3.75V16.5h15v-3.25c0-2.5-5-3.75-7.5-3.75z" fill="#1c1f21"></path></svg>
            </div>
