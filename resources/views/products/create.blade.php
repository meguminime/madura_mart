                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-3 px-3 pt-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="harga_jual" name="harga_jual" placeholder="Enter Product Price" value="{{ old('harga_jual', 0) }}" min="0">
                                            </div>
                                        </div>
                                        <div class="mb-3 px-3 pt-3">
                                            <label for="stok" class="form-label">Stock</label>
                                            <input type="number" class="form-control" id="stok" name="stok" placeholder="Enter Product Stock" value="{{ old('stok', 0) }}" min="0">
                                        </div>
                                        <div class="mb-3 px-3 pt-3">
                                            ...
                                            <img id="image_preview" src="#" alt="Image Preview" class="mt-3 d-none" style="max-width: 200px; max-height: 200px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); object-fit: cover;">
                                        </div>
                                    </div>
                                </div>
